...
# --- LATENCY VARIABLES ---
last_speech_time = time.perf_counter() #CREATES 2 VARIABLES YUHHh
current_text = ""
speaking = False
...
try:
    while True:
        ...
        if is_active or speaking:
            if rec.AcceptWaveform(data): #checks if person is mid sentence
                ...
                #print("Entering this")
                partial = json.loads(rec.PartialResult()) #makes dictionary 
